...
def render_video():
    ...
    filter_complex = (
        ...
        "[bg][char]overlay=x=(W-w)/2:y=(H-h)/2+20*sin(2*PI*t*1.5):format=auto[v];"
    ...
    cmd = [
        ...
        "-map", "[v]",
        "-map", "[a]",
        "-vf", "subtitles=output/subtitles.srt:force_style='Fontsize=48,Outline=3,Shadow=1,Alignment=2'",
        "-t", "90",
        "-r", "30",
        "-pix_fmt", "yuv420p",
